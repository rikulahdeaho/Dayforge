      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <SurfaceCard palette={palette} style={styles.kpiCard}>
          ...
          <View style={[styles.kpiRow, styles.kpiRowLast, { borderColor: palette.border }]}> 
            ...
            <Text style={[styles.kpiValue, { color: reflection ? palette.accent : palette.text }]}> 
              {reflection ? 'Saved' : 'None'}
            </Text>
          </View>
        </SurfaceCard>
        ...
        <SurfaceCard palette={palette} style={styles.snippetCard}>
          ...
          <Text numberOfLines={3} style={[styles.snippetText, { color: palette.text }]}>
            {reflectionSnippet}
          </Text>
        </SurfaceCard>
      </ScrollView>
