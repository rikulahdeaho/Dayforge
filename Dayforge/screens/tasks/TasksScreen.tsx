...
import { usePendingTaskDeletion } from './hooks/usePendingTaskDeletion';
...
export default function TaskScreen() {
  ...
  const { pendingTaskDeletion, queueTaskDeletion, undoTaskDeletion } = usePendingTaskDeletion(removeTask);
