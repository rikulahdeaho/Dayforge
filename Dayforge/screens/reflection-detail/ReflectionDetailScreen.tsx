      ...
      <View style={[styles.safe, { backgroundColor: palette.background }]}>
        ...
        <View style={styles.center}>
          ...
          <Pressable onPress={() => router.back()} style={[styles.backButton, { backgroundColor: palette.accent }]}>
            <Text style={[styles.backButtonText, { color: palette.onAccent }]}>Back</Text>
          </Pressable>
        </View>
      </View>
    );
          ...
          <SurfaceCard palette={palette} style={styles.card}>
            ...
            <View style={styles.actionsRow}>
              ...
              <Pressable
                ...
                <Text style={[styles.deleteActionText, { color: palette.danger }]}>Delete</Text>
              </Pressable>
            </View>
            ...
            {isEditing ? (
              <Pressable
                ...
                <Text style={[styles.saveActionText, { color: palette.onAccent }]}>Save changes</Text>
              </Pressable>
            ) : null}
          </SurfaceCard>
        </ScrollView>
