        ...
        <ScrollView ref={scrollRef} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          ...
          <SurfaceCard palette={palette} style={styles.formCard}>
            <View style={[styles.iconWrap, { backgroundColor: palette.cardStrong }]}>
              <SymbolView name={resolveSymbolName({ ios: 'target', android: 'track_changes', web: 'track_changes' })} size={30} tintColor={palette.accent} />
            </View>
            ...
            <View style={styles.actionRow}>
              ...
              <Pressable onPress={saveGoal} disabled={!goalTitle.trim()} style={[styles.primaryBtn, { backgroundColor: palette.accent, opacity: goalTitle.trim() ? 1 : 0.5 }]}>
                <Text style={[styles.primaryBtnText, { color: palette.onAccent }]}>Save Focus</Text>
              </Pressable>
            </View>
          </SurfaceCard>
        </ScrollView>
